...
export default function BunkersGrid({
  ...
  // initialTimers: for each bunker get bunker-level remainingSeconds (snapshot.bunkerTimers[i].remainingSeconds)
  // fallback: sum of layer initialSeconds or remainingSeconds
